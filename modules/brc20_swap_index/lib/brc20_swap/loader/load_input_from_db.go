...
func LoadBRC20InputDataFromDB(ctx context.Context, brc20Datas chan *model.InscriptionBRC20Data, startHeight, endHeight int) error {
	logger.Log.Info("LoadBRC20InputDataFromDB",
