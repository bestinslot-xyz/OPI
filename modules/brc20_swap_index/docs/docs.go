    ...
    "definitions": {
        ...
        "model.InscriptionResp": {
            ...
            "properties": {
                ...
                "inscriptionIndex": {
                    "description": "Current inscription index, indicating the sequence of repetition, 0 for first occurrence",
                    "type": "integer"
                },
                "inscriptionNumber": {
        ...
        "model.TxStandardOutResp": {
            ...
            "properties": {
                ...
                "codeType": {
                    "description": "Script type of the current output: 0: None, 1: FT, 2: Unique, 3: NFT, 4: CodeType_P2PK, 5: CodeType_P2PKH, 6: CodeType_P2SH, 7: CodeType_P2WPKH, 8: CodeType_P2WSH, 9: CodeType_P2TR",
                    "type": "integer"
                },
                "height": {
                ...
                "isOpInRBF": {
                    "description": "Indicates if the current transaction is an RBF (Replace-By-Fee) transaction",
                    "type": "boolean"
                },
                "isSpent": {
